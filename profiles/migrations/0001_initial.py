    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_street_address_1', models.CharField(blank=True, max_length=250, null=True)),
                ('default_street_address_2', models.CharField(blank=True, max_length=250, null=True)),
